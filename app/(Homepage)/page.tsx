        ...
        <div className="flex h-screen w-full flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 flex gap-4 text-center pb-36 md:pb-0 h-screen md:h-auto  md:pt-0 items-center justify-center flex-col bg-transparent p-4">
                ...
                <div className=" p-6 md:p-8 rounded-lg  w-full max-w-md  ">
                    <label className="block text-sm  w-full text-gray-700 py-1 text-left">Username</label>                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <button
                            disabled
                            className={`mt-2 w-full py-2 rounded-md text-gray-600 text-sm md:text-base bg-gray-200 cursor-not-allowed`}>
                            Next
                        </button>
                    </form>
